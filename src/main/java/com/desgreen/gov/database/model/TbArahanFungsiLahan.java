...
@Entity
@Table(name = "tb_arahan_fungsi_lahan")
public class TbArahanFungsiLahan {
	...
	@OneToMany(mappedBy = "arahanFungsiLahanBean")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TbArahanFungsiLahan other = (TbArahanFungsiLahan) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public String toString() {
		return "TbArahanFungsiLahan [id=" + id + "]";
	}
