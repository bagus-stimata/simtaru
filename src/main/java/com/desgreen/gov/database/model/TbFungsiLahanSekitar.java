...
@Entity
@Table(name = "tb_fungsi_lahan_sekitar")
public class TbFungsiLahanSekitar {
	...
	@OneToMany(mappedBy = "fungsiLahanSekitarBean")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TbFungsiLahanSekitar other = (TbFungsiLahanSekitar) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public String toString() {
		return "TbFungsiLahanSekitar [id=" + id + "]";
	}
