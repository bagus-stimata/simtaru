...
@Entity
@Table(name = "tb_jenisprasarana")
public class TbJenisPrasarana {
    ...
    @OneToMany(mappedBy = "jenisPrasaranaBean")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TbJenisPrasarana other = (TbJenisPrasarana) obj;
		if (id != other.id)
			return false;
		return true;
	}
    ...
    /**
     * @return List<TbPrasarana> return the listPrasarana
     */
    ...
    /**
     * @param listPrasarana the listPrasarana to set
     */
