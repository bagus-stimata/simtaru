...
@Entity
@Table(name = "tb_jenissarana")
public class TbJenisSarana {
    ...
    @OneToMany(mappedBy = "jenisSaranaBean")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TbJenisSarana other = (TbJenisSarana) obj;
		if (id != other.id)
			return false;
		return true;
	}
    ...
    /**
     * @return List<TbSarana> return the listSarana
     */
    ...
    /**
     * @param listSarana the listSarana to set
     */
