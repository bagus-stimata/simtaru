...
@Entity
@Table(name = "tb_status_wilayah")
public class TbStatusWilayah {
	...
	@OneToMany(mappedBy = "statusWilayahBean")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TbStatusWilayah other = (TbStatusWilayah) obj;
		if (id != other.id)
			return false;
		return true;
	}
